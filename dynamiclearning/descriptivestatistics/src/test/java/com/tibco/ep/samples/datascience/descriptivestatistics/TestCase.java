package com.tibco.ep.samples.datascience.descriptivestatistics;
...
public class TestCase extends UnitTest {
    ...
    public static void setupServer() throws StreamBaseException, ConfigurationException, InterruptedException {
        ...
        server.startServer();
        server.loadApp("com.tibco.ep.samples.datascience.descriptivestatistics.descriptivestatistics");
    }
